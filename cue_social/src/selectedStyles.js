...
export const optionsTags = [
    ...
    {
        "label": "Mono Life on Land",
        "value": "Mono Life on Land",
        "color": "#b3ee4c"
    },
    {
        "label": "Mono Oceans & Seas",
        "value": "Mono Oceans & Seas",
        "color": "#0090fe"
    },
    {
        "label": "Mono Paleontology",
        "value": "Mono Paleontology",
        "color": "#fc9512"
    },
    {
        "label": "Mono Science",
    ...
    {
        "label": "Power per Turn",
        "value": "Power per Turn",
        "color": "#DE3163"
    },
    {
        "label": "Rainbow",
...
export const customStylesAlbums = {
...
export const customStylesCollections = {
    option: (provided, state) => ({
        ...provided,
...
export const customStylesTags = {
    ...
    multiValueRemove: (provided, state) => ({
        ...
        color: 'white',
        ':hover': {
            backgroundColor: 'darken(' + state.data.color + ', 10%)',
            color: 'white',
        },
    }),
};

export const customStylesCards = {
    option: (provided, state) => ({
        ...provided,
